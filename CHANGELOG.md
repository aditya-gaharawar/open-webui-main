...
- 🧩 **External Tool Server Support via OpenAPI**: Connect AnswerAI to any OpenAPI-compatible REST server instantly—offering immediate integration with thousands of developer tools, SDKs, and SaaS systems for powerful extensibility. Learn more: https://github.com/answer-ai/openapi-servers
- 🛠️ **MCP Server Support via MCPO**: You can now convert and expose your internal MCP tools as interoperable OpenAPI HTTP servers within AnswerAI for seamless, plug-n-play AI toolchain creation. Learn more: https://github.com/answer-ai/mcpo
...
- **🖥️ Desktop App Preparations**: Ongoing work to support the upcoming AnswerAI desktop app. Follow our progress and updates here: https://github.com/answer-ai/desktop
...
- **🔧 Pipelines Support**: AnswerAI now includes a plugin framework for enhanced customization and functionality (https://github.com/answer-ai/pipelines). Easily add custom logic and integrate Python libraries, from AI agents to home automation APIs.
...
- **📦 Helm Charts**: Removed Helm charts, now available in a separate repository (https://github.com/answer-ai/helm-charts).
...
- 🌍 **Localization**: You can now change the UI language in Settings > General. We support Ukrainian, German, Farsi (Persian), Traditional and Simplified Chinese and French translations. You can help us to translate the UI into your language! More info in our [CONTRIBUTION.md](https://github.com/answer-ai/answer-ai/blob/main/docs/CONTRIBUTING.md#-translations-and-internationalization).
