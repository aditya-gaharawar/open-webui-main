...
from answer_ai.internal.db import Base, get_db
from answer_ai.utils.redis import get_redis_connection
...
class AppConfig:
    ...
    def __setattr__(self, key, value):
        if isinstance(value, PersistentConfig):
            ...
            if self._redis:
                redis_key = f"answer-ai:config:{key}"
...
if ENV == "prod":
    if OLLAMA_BASE_URL == "/ollama" and not K8S_FLAG:
        ...
        OLLAMA_BASE_URL = "http://ollama-service.answer-ai.svc.cluster.local:11434"
...
PINECONE_INDEX_NAME = os.getenv("PINECONE_INDEX_NAME", "answer-ai-index")
