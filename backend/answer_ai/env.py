...
if FROM_INIT_PY:
    PACKAGE_DATA = {"version": importlib.metadata.version("answer-ai")}
else:
    try:
...
try:
    ...
    changelog_content = (pkgutil.get_data("answer_ai", "CHANGELOG.md") or b"").decode()
...
if FROM_INIT_PY:
    ...
    if DATA_DIR.exists() and DATA_DIR != NEW_DATA_DIR:
        ...
        shutil.make_archive(DATA_DIR.parent / "answer_ai_data", "zip", DATA_DIR)
...
OTEL_SERVICE_NAME = os.environ.get("OTEL_SERVICE_NAME", "answer-ai")
