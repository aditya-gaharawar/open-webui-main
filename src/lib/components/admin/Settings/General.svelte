						...
						<div class="flex w-full justify-between items-center">
							<div class="flex flex-col text-xs text-gray-700 dark:text-gray-200">
								<div class="flex gap-1">
									...
									<a
										href="https://github.com/answer-ai/answer-ai/releases/tag/v{version.latest}"
										target="_blank"
									>
										{updateAvailable === null
					...
					<div class="mb-2.5">
						...
						<div class="mt-1">
							<div class="flex space-x-1">
								...
								<a href="https://github.com/answer-ai/answer-ai" target="_blank">
									<img
										alt="Github Repo"
										src="https://img.shields.io/github/stars/answer-ai/answer-ai?style=social&label=Star us on Github"
									/>
								</a>
							</div>
						</div>
